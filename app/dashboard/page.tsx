...
// Компонент для карточек-сводок
const SummaryCards: React.FC = () => (
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
    {mockData.summary.map((card, index) => (
      <div key={index} className="bg-white dark:bg-[#1a233b] rounded-2xl shadow-lg p-6 flex flex-col items-center justify-center border border-gray-200 dark:border-gray-700">
...
// Компонент для графика выигранных сделок
...
// Компонент для графика прогноза сделок
const DealsProjectionChart: React.FC = () => (
  <div className="bg-white dark:bg-[#1a233b] p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Deals projection (future 12 months)</h3>
    <div className="flex justify-between items-center text-sm text-gray-500 dark:text-gray-400 mb-6">
      <div className="flex items-center space-x-4">
        <div className="flex items-center">
          <span className="w-3 h-3 rounded-full bg-[#1d4ed8] mr-2"></span>
    ...
    <ResponsiveContainer width="100%" height={300}>
      <LineChart data={mockData.dealsProjection} margin={{ top: 5, right: 20, left: -20, bottom: 5 }}>
        ...
        <YAxis tick={{ fill: 'gray' }} axisLine={{ stroke: '#e5e7eb', className: 'dark:stroke-gray-700' }} />
        <Tooltip />
        <Line type="monotone" dataKey="projected" stroke="#1d4ed8" activeDot={{ r: 8 }} />
...
const SalesPipelineChart: React.FC = () => {
  const COLORS = ['#3b82f6', '#22c55e', '#ef4444', '#f59e0b', '#06b6d4', '#4f46e5'];
  return (
    <div className="bg-white dark:bg-[#1a233b] p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 h-full flex flex-col">
      <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Sales pipeline</h3>
...
const DealLossReasonsChart: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#1a233b] p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 h-full flex flex-col">
      <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Deal loss reasons</h3>
      <div className="flex-1 flex items-center justify-center">
        <ResponsiveContainer width="100%" height={200}>
          <PieChart>
            <Pie
  ...
  return (
    <div className="w-64 p-6 bg-white dark:bg-[#1a233b] rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
      <div className="flex items-center justify-between mb-4">
        <span className="text-lg font-semibold text-gray-900 dark:text-white">Report date</span>
      ...
      <div className="grid grid-cols-2 gap-2 text-sm text-gray-700 dark:text-gray-300 mb-4">
        <input type="date" className="p-2 rounded-lg border border-gray-300 dark:bg-gray-700 dark:border-gray-600" value="2024-01-01" />
        <input type="date" className="p-2 rounded-lg border border-gray-300 dark:bg-gray-700 dark:border-gray-600" value="2025-05-31" />
      </div>
      <div className="space-y-4">
        <div>
          <span className="text-sm font-semibold text-gray-900 dark:text-white">Deal Owner</span>
        ...
        <div>
          <span className="text-sm font-semibold text-gray-900 dark:text-white">Deal Stage</span>
          <select className="w-full p-2 mt-1 rounded-lg border border-gray-300 dark:bg-gray-700 dark:border-gray-600">
            <option>All</option>
        ...
        <div>
          <span className="text-sm font-semibold text-gray-900 dark:text-white">Pipeline</span>
          <select className="w-full p-2 mt-1 rounded-lg border border-gray-300 dark:bg-gray-700 dark:border-gray-600">
            <option>All</option>
        ...
        <div>
          <span className="text-sm font-semibold text-gray-900 dark:text-white">Deal Label</span>
          <select className="w-full p-2 mt-1 rounded-lg border border-gray-300 dark:bg-gray-700 dark:border-gray-600">
            <option>All</option>
      ...
      <div className="mt-8 p-4 bg-gray-100 dark:bg-gray-700 rounded-xl text-center">
        <h4 className="font-semibold text-gray-900 dark:text-white">Have questions?</h4>
        <p className="text-sm text-gray-600 dark:text-gray-300">Dashboard setup guide</p>
        <p className="text-sm text-blue-600 dark:text-blue-400 font-bold">Book a demo</p>
        <p className="text-sm text-blue-600 dark:text-blue-400 font-bold">Contact support</p>
      </div>
    </div>
  );
};
