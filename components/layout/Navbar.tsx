...
const Navbar = () => {
  ...
  return (
    <div className="bg-gray-100 dark:bg-black">
      <div className="bg-white border border-gray-200 shadow dark:bg-white/5 dark:border-white/10 dark:shadow-white/10">
        <div className="sticky top-0 z-50 w-full min-h-[64px] flex-shrink-0 border-b border-gray-300 dark:border-white/20 bg-transparent shadow-none px-4 flex items-center justify-between flex-wrap gap-2 overflow-y-hidden">
