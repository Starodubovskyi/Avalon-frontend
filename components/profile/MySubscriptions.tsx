export default function MySubscriptions() {
  return (
    ...
    // <div class="bg-dark-700 px-4 py-16 min-h-screen">
    //   <div
    //     aria-hidden="true"
    ...
    //           <span class="text-3xl sm:text-4xl font-bold text-white">$19</span>{" "}
    //           / Month
    //         </p>
    ...
    //         <p class="text-lg sm:text-xl text-center mb-8 mt-4 text-gray-400">
    //           <span class="text-3xl sm:text-4xl font-bold text-white">$49</span>{" "}
    //           / Month
    //         </p>
    //         <ul class="list-none list-inside mb-6 text-center text-gray-300">
    ...
    //         </h2>
    //         <p class="text-lg sm:text-xl text-center mb-8 mt-4 text-gray-400">
    //           <span class="text-3xl sm:text-4xl font-bold text-white">$99</span>{" "}
    //           / Month
    //         </p>
    //         <ul class="list-none list-inside mb-6 text-center text-gray-300">
